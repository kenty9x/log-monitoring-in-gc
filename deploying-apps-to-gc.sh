...
# In Cloud Shell, click Open Editor (Cloud Shell Editor), then click Open in a new window if required.
...
In the Create Cluster dialog box, to the right of the Standard option, click Configure.
...
In Configure how this service is triggered, select Allow unauthenticated invocations. Leave the rest as defaults.
