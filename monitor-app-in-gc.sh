...
# In Cloud Shell, click Open Editor (open_editor_2) and then Open in a window.
...
If you don't see VM Instances right away, wait a minute and refresh your browser.
Optionally, return to the Dashboards page and click the +Create Dashboard. Try to create a custom dashboard.
...
Click on drop down arrow next to Notification Channels, then click on Manage Notification Channels. A Notification channels page will open in new tab.
